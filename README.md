[![React App CI](https://github.com/ChaudhariSumit/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/ChaudhariSumit/ci-cd-with-actions/actions/workflows/ci.yml)
